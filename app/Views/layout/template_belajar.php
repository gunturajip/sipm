...
<body>
    <header class="py-2 bg-light fixed-top border-bottom">
        <div class="container-md d-flex flex-wrap justify-content-between">
            ...
            <ul class="pagination d-flex col-md-auto justify-content-center align-items-center m-0">
                <li class="page-item">
                    <a class="page-link link-dark d-flex align-items-center gap-1" href="#" aria-label="Previous">
                ...
                <li class="page-item">
                    <a class="page-link link-dark d-flex align-items-center gap-1" href="#">
                ...
                <li class="page-item">
                    <a class="page-link link-dark d-flex align-items-center gap-1" href="#" aria-label="Next">
            ...
            <ul class="nav d-flex col-md-3 justify-content-end align-items-center gap-2">
                <li class="nav-item">
    ...
    <footer class="py-3 bg-light fixed-bottom border-top">
